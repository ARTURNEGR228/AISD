...
class TestYandexSearch:
    ...
    @allure.description("Проверяет, что поиск возвращает результаты с ожидаемым текстом")
    ...
    def test_yandex_search_functionality(
        self, browser, base_url, search_query, expected_text
    ):
